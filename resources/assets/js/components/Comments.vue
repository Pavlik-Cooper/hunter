    ...
    export default {
        ...
        methods: {
            ...
            fetchComments() {
                ...
                axios.get(`/threads/${this.channel}/${this.slug}/comments/` + this.commentUrl).then(res => {
            ...
            saveComment() {
                ...
                if (this.message != null && this.message != ' ') {
                    ...
                    axios.post(`/threads/${this.channel}/${this.slug}/comments`, {
            ...
            voteComment(commentId, commentType, index, index2, voteType) {
                ...
                if (this.user) {
                    ...
                    axios.post(`/threads/${this.channel}/${this.slug}/comments/` + commentId + '/vote', {
            ...
            spamComment(commentId, commentType, index, index2) {
                ...
                if (this.user) {
                    ...
                    axios.post(`/threads/${this.channel}/${this.slug}/comments/` + commentId + '/spam', {
